        ...
        <div class="bg-gradient-to-r from-theme-bg-muted to-theme-card border-b border-theme-bg-muted p-6">
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
              ...
              <div>
                <h2 class="text-2xl font-bold text-theme-primary">Tous les Avertissements</h2>
                ...
                >
                  ...
                  <td class="px-6 py-4">
                    <div class="flex items-center space-x-3">
                      <img :src="getClassIcon(warning.character.class)" :alt="`Classe ${warning.character.class}`" class="w-8 h-8 rounded-lg border-2 border-theme-border" />
                      <span class="text-theme-primary font-semibold">{{ warning.character.pseudo }}</span>
                    </div>
                  </td>
                  <td class="px-6 py-4">
                    <div class="max-w-md">
      ...
      <div class="w-full max-w-2xl bg-theme-card border border-theme-border rounded-2xl shadow-2xl relative">
        ...
        <div class="p-6 space-y-6">
          ...
          <div class="space-y-2">
            ...
            <div v-if="newWarning.characterId" class="flex items-center space-x-4 p-4 bg-theme-bg-muted rounded-lg border border-theme-border">
              <img :src="selectedCharacterIcon" :alt="`Classe ${selectedCharacterName}`" class="w-10 h-10 rounded-lg border-2 border-theme-border" />
              <div class="flex-1">
                <span class="text-lg font-semibold text-theme-primary">{{ selectedCharacterName }}</span>
              </div>
              <button
                type="button"
            ...
            <div v-else class="space-y-3">
              ...
              <div class="max-h-48 overflow-y-auto bg-theme-bg-muted border-2 border-theme-border rounded-lg p-3">
                ...
                >
                  ...
                  <span class="text-base text-theme-text group-hover:text-theme-primary transition-colors duration-200">{{ char.pseudo }}</span>
                </div>
              </div>
            </div>
          </div>
    ...
    >
      <div class="w-full max-w-2xl bg-theme-card border border-theme-border rounded-2xl shadow-2xl relative">
        ...
        <div class="p-6 space-y-6">
          <!-- Description Field -->
          <div class="space-y-2">
            <label for="editDescription" class="block text-sm font-medium text-theme-text">
              Description <span class="text-theme-error">*</span>
            </label>
            <textarea
              id="editDescription"
      ...
      <div class="w-full max-w-md bg-theme-card border border-theme-border rounded-2xl shadow-2xl">
        ...
        <div class="p-6">
          <p class="text-theme-text mb-6">
            Êtes-vous sûr de vouloir supprimer cet avertissement pour <span class="text-theme-primary font-semibold">{{ selectedWarning?.character?.pseudo }}</span> ?
          </p>
