  ...
  <div class="min-h-screen bg-black text-white">
    ...
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="text-center mb-12">
        <h1 class="text-6xl font-bold text-amber-400 mb-6">Gestion des Avertissements</h1>
        ...
        <p class="text-gray-400 mt-6 text-lg">Gérez les avertissements des membres Erebor</p>
      </div>
        ...
        <div class="bg-gradient-to-r from-gray-800 to-gray-900 border-b border-gray-700 p-6">
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
              ...
              <div>
                <h2 class="text-2xl font-bold text-amber-400">Tous les Avertissements</h2>
                ...
                >
                  ...
                  <td class="px-6 py-4">
                    <div class="flex items-center space-x-3">
                      <img :src="getClassIcon(warning.character.class)" :alt="`Classe ${warning.character.class}`" class="w-8 h-8 rounded-lg border-2 border-gray-600" />
                      <span class="text-amber-400 font-semibold">{{ warning.character.pseudo }}</span>
                    </div>
                  </td>
                  <td class="px-6 py-4">
                    <div class="max-w-md">
        ...
        <div class="p-6 space-y-6">
          ...
          <div class="space-y-2">
            <label class="block text-sm font-medium text-gray-300">
              Personnage <span class="text-red-400">*</span>
            </label>
            
            <!-- If character is selected -->
            <div v-if="newWarning.characterId" class="flex items-center space-x-4 p-4 bg-gray-800 rounded-lg border border-gray-600">
              <img :src="selectedCharacterIcon" :alt="`Classe ${selectedCharacterName}`" class="w-10 h-10 rounded-lg border-2 border-gray-600" />
              <div class="flex-1">
                <span class="text-lg font-semibold text-amber-400">{{ selectedCharacterName }}</span>
              </div>
              <button
                type="button"
            ...
            <div v-else class="space-y-3">
              ...
              <div class="max-h-48 overflow-y-auto bg-gray-800 border-2 border-gray-600 rounded-lg p-3">
                ...
                >
                  ...
                  <span class="text-base text-gray-300 group-hover:text-amber-400 transition-colors duration-200">{{ char.pseudo }}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="w-full max-w-md bg-gray-900 border border-gray-800 rounded-2xl shadow-2xl">
        ...
        <div class="p-6">
          <p class="text-gray-300 mb-6">
            Êtes-vous sûr de vouloir supprimer cet avertissement pour <span class="text-amber-400 font-semibold">{{ selectedWarning?.character?.pseudo }}</span> ?
          </p>
