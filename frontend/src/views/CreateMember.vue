  ...
  >
    ...
    <div class="flex justify-center space-x-6 my-4">
      <button
        ...
        :class="{
          'bg-[#b02e2e] text-[#f3d9b1]': activeTab === 'active',
      ...
      <button
        ...
        :class="{
          'bg-[#b02e2e] text-[#f3d9b1]': activeTab === 'archived',
    ...
    <div v-if="activeTab === 'active'">
      <!-- Active Characters List (existing code) -->
      <div
    ...
    <div v-if="activeTab === 'archived'">
      <div
        class="bg-[#fff5e6] border-4 border-[#b07d46] rounded-lg shadow-lg w-11/12 max-w-6xl p-6 mb-6"
      >
        <h2 class="text-2xl font-bold text-[#b02e2e] mb-4">Archived Characters</h2>

        <!-- Search Bar -->
        <input
          type="text"
          v-model="archivedSearchQuery"
          placeholder="Search archived characters..."
          class="w-full border-2 border-[#b07d46] bg-[#fffaf0] rounded-lg p-3 text-lg focus:outline-none focus:ring-2 focus:ring-[#f3d9b1] mb-4"
        />

        <!-- Archived Member Table -->
        <div class="overflow-y-auto max-h-96">
          <table class="w-full text-center border-collapse">
            <thead class="sticky top-0 bg-[#b02e2e] z-10">
              <tr class="text-[#f3d9b1] text-lg">
            ...
            <tbody>
              ...
              >
                <tr class="transition-all group relative hover:bg-[#f3d9b1]">
                  ...
                  <td class="p-4">
                    <button
                      @click="unarchiveCharacter(member.id)"
