        ...
        <div class="bg-gradient-to-r from-theme-bg-muted to-theme-card border-b border-theme-bg-muted p-6">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              class="px-6 py-3 bg-gradient-to-r from-theme-error to-theme-error hover:from-theme-error hover:to-theme-error text-theme-text font-bold rounded-xl transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-theme-error/30 flex items-center space-x-2"
            >
                ...
                >
                  ...
                  <td class="px-6 py-4 text-right">
                    <button
                      ...
                      class="px-4 py-2 bg-theme-error hover:bg-theme-primary text-theme-text font-medium rounded-lg transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-theme-error/30 flex items-center space-x-2 ml-auto"
                    >
