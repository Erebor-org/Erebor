...
export default {
  ...
  methods: {
    ...
    async submitCharacter() {
      ...
      try {
        // API POST request
        const response = await axios.post('http://localhost:9000/characters', {
    ...
    async submitMuleCharacter() {
      ...
      try {
        const response = await axios.post('http://localhost:9000/mules', {
    ...
    async fetchRecruiters() {
      try {
        const response = await axios.get('http://localhost:9000/characters/recruiters'); // Replace with your actual API endpoint
