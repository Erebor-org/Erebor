  ...
  <form @submit.prevent="submitMuleCharacter">
    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <!-- Pseudo -->
        <div class="space-y-2">
          <label for="mulePseudo" class="block text-sm font-medium text-theme-text">
          ...
          <input
            ...
            required
            :class="{ 'border-theme-error bg-theme-error/20': isMulePseudoInvalid }"
          />
          <div
        ...
        <!-- Pseudo Ankama -->
        <div class="space-y-2">
          <label for="muleAnkamaPseudo" class="block text-sm font-medium text-theme-text">
          ...
          <input
            ...
            required
            :class="{ 'border-theme-error bg-theme-error/20': isMuleAnkamaPseudoInvalid }"
          />
          <div
      ...
      <div class="space-y-4">
        <label class="block text-sm font-medium text-theme-text">
          Personnage Principal <span class="text-theme-error">*</span>
        </label>
